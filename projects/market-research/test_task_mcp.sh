...
{"jsonrpc": "2.0", "id": 2, "method": "tools/call", "params": {"name": "task", "arguments": {"task_id": 1, "service": "market-research", "repository": "5dlabs/platform", "docs_repository": "5dlabs/platform", "docs_project_directory": "projects/market-research", "github_user": "pm0-5dlabs", "working_directory": ".", "model": "claude-3-5-sonnet-20241022", "continue_session": false}}}
EOF
