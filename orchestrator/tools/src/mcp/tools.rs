    ...
    json!({
        ...
        "inputSchema": {
            ...
            "properties": {
                "working_directory": {
                    "type": "string",
                    "description": "Working directory containing .taskmaster folder (optional, can be set via FDL_DEFAULT_WORKING_DIR environment variable or auto-detects from current directory). Use relative paths like '_projects/simple-api'."
                },
                "model": {
                    "type": "string",
