    ...
    json!({
        ...
        "inputSchema": {
            ...
            "properties": {
                ...
                "working_directory": {
                    "type": "string",
                    "description": "Working directory containing .taskmaster folder (auto-detected from current directory if not specified). Supports both relative and absolute paths."
                },
                "force": {
                    "type": "boolean",
